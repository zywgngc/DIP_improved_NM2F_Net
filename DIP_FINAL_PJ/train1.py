...
from model_develop import DM2FNet
...
if __name__ == '__main__':
    ...
    # current_time = datetime.datetime.now().strftime("%Y-%m-%d %H-%M-%S")  # 使用符合Windows规范的时间格式
    # log_path = os.path.join(args.ckpt_path, args.exp_name, f'{current_time}.txt')  # 安全的日志文件路径
    main()
